...
{
  "id": "ws-LUdecomposition-2",
  "level": "2",
  "url": "sec-LUdecomposition.html#ws-LUdecomposition-2",
  "type": "Objectives",
  "number": "",
  "title": "",
  "body": "   Find and use an LU decomposition of a matrix to solve a linear system.    Explore properties related to LU decomposition, including uniqueness, invertibility, and the effect of swapping rows.    "
},
{
  "id": "ws-LUdecomposition-3-1-3",
  "level": "2",
  "url": "sec-LUdecomposition.html#ws-LUdecomposition-3-1-3",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "   ,         "
...
{
  "id": "ws-LUdecomposition-3-1-4",
  "level": "2",
  "url": "sec-LUdecomposition.html#ws-LUdecomposition-3-1-4",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": "   ,         "
...
{
  "id": "ws-LUdecomposition-3-2",
  "level": "2",
  "url": "sec-LUdecomposition.html#ws-LUdecomposition-3-2",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "Products of triangular matrices.",
  "body": "Products of triangular matrices   Consider two lower triangular matrices, . Calculate the product (or enough of it) and explain why is lower triangular.   "
},
{
  "id": "ws-LUdecomposition-3-3",
  "level": "2",
  "url": "sec-LUdecomposition.html#ws-LUdecomposition-3-3",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "Uniqueness?",
  "body": "Uniqueness?   In an earlier example, we showed that . Consider a diagonal matrix, . Calculate and .  What does equal? What does this tell you about the uniqueness of LU factorizations?   "
},
{
  "id": "LU-part-system",
  "level": "2",
  "url": "sec-LUdecomposition.html#LU-part-system",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "",
  "body": "  Solve using LU decomposition for .     , so and    "
},
{
  "id": "ws-LUdecomposition-4-2",
  "level": "2",
  "url": "sec-LUdecomposition.html#ws-LUdecomposition-4-2",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "",
  "body": "  Recall we define in terms of elementary matrices which are invertible, but all we've said about is that is the result of applying some row operations.     Suppose . Calculate and determine whether or not is invertible. Will be invertible for any lower triangular matrix ?     , and no, you always get something like       Determine whether or not is invertible if . Does have exactly one solution for any possible ?    Guide them through thinking about how you need to solve and what the form of means for that.    "
},
{
  "id": "ws-LUdecomposition-4-3",
  "level": "2",
  "url": "sec-LUdecomposition.html#ws-LUdecomposition-4-3",
  "type": "Worksheet Exercise",
  "number": "7",
  "title": "",
  "body": "  A matrix obtained from the identity matrix by swapping rows some number of times is called a permutation matrix, and it's always invertible (perform the same swaps in the reverse order). When computers solve they often perform a permutation and find an LU decomposition for so that they are solving by solving .  Solve the system in Exercise above again, this time by using Sage to calculate , and . Then by hand, calculate and use substitution to solve and . Verify that you get the same answer you got before.    "
},
{
  "id": "ww-LUsolvesystem",
  "level": "2",
  "url": "sec-LUdecomposition.html#ww-LUsolvesystem",
  "type": "Exercise",
  "number": "2.6.1",
  "title": "Use LU decomposition to solve a system.",
  "body": "Use LU decomposition to solve a system    Use the given LU factorization to find all solutions to  ,    SOLUTION: Solve , , using back substitution, to obtain . Now solve , , using back substitution, to obtain .       "
},
{
  "id": "ww-LUdecomp2by2",
  "level": "2",
  "url": "sec-LUdecomposition.html#ww-LUdecomp2by2",
  "type": "Exercise",
  "number": "2.6.2",
  "title": "Find an LU decomposition.",
  "body": "Find an LU decomposition    Find the factorization of That is, write where is a lower triangular matrix with ones on the diagonal, and is an upper triangular matrix.          "
},
{
  "id": "ww-LUdecomp3by3",
  "level": "2",
  "url": "sec-LUdecomposition.html#ww-LUdecomp3by3",
  "type": "Exercise",
  "number": "2.6.3",
  "title": "Find an LU decomposition.",
  "body": "Find an LU decomposition    For this problem enter matrices using bracket notation. So the matrix   would be entered as [[2,3,-1],[-2,-5,6]].  Find an LU factorization for                SOLUTION:  Thus and .       "
},
{
  "id": "ww-LUinverse",
  "level": "2",
  "url": "sec-LUdecomposition.html#ww-LUinverse",
  "type": "Exercise",
  "number": "2.6.4",
  "title": "Use LU decomposition to find an inverse.",
  "body": "Use LU decomposition to find an inverse    If L and U are invertible, then = . Find from the given LU factorization:        SOLUTION: We have that       "
},
{
  "id": "ww-LUtruefalse",
  "level": "2",
  "url": "sec-LUdecomposition.html#ww-LUtruefalse",
  "type": "Exercise",
  "number": "2.6.5",
  "title": "True\/False LU Decomposition Properties.",
  "body": "True\/False LU Decomposition Properties    Determine which of the following statements are true and which are false.    Every square matrix has a PLU decomposition.    Every matrix that is in row echelon form is upper triangular.    Every square matrix has an LU decomposition.    The upper triangular matrix in an LU decomposition is always invertible.         "
},
{
  "id": "backmatter-2",
  "level": "1",
